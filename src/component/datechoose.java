...
public class datechoose extends JPanel{
        ...
        private datechoose(java.util.Date date, String format, int startDAY)
        {
        ...
        public static datechoose getInstance(java.util.Date date, String format)
        {
            return new datechoose(date, format, defaultStartDAY);
        }

        public static datechoose getInstance(java.util.Date date)
        {
        ...
        {
            private java.util.List<DayLabel> list;

            public LabelManager()
            {
                list = new ArrayList<datechoose.DayLabel>();
            }
